...
export default function SubDebateModal({ messageContent, onConfirm, onClose, loading }: Props) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md mx-4 rounded-2xl bg-white dark:bg-gray-900 ring-1 ring-gray-300/60 dark:ring-gray-700/60 shadow-2xl"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 px-5 py-3.5">
          <div className="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="h-4 w-4 text-amber-600 dark:text-amber-400">
            ...
            <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">Start a sub-debate</span>
          </div>
          <button onClick={onClose} className="rounded p-1 text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 transition-colors">
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="flex gap-2">
            <button
              onClick={onClose}
              className="flex-1 rounded-xl border border-gray-300 dark:border-gray-700 py-2 text-sm text-gray-600 dark:text-gray-400 hover:border-gray-300 dark:hover:border-gray-500 hover:text-gray-800 dark:hover:text-gray-200 transition-colors"
            >
              Cancel
            </button>
            <button
