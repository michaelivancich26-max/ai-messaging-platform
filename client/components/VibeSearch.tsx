    ...
    <div className="border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 px-4 py-3">
      <form onSubmit={handleSubmit} className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={onClose}
          className="rounded-xl p-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 transition-colors"
        >
