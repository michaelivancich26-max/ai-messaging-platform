              ...
              {leaderboard.length === 0 ? (
                ...
                leaderboard.map((entry, i) => {
                  ...
                  return (
                    <div
                      key={entry.id}
                      className={`flex items-center gap-3 px-4 py-3 border-b border-gray-800 last:border-0 ${isMe ? "bg-violet-950/30" : ""}`}
                    >
                      ...
                      <button
                        ...
                        className={`flex-1 truncate text-left text-sm font-medium hover:underline ${isMe ? "text-violet-300" : "text-gray-200"}`}
                      >
