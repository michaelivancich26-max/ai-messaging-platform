...
const COLOR = {
  red:     { card: "border-red-900/40 hover:border-red-700/60",     icon: "bg-red-950/60 ring-red-900/60 group-hover:ring-red-700", text: "text-red-400",     bar: "bg-red-500",     badge: "bg-red-950/40 text-red-400" },
  blue:    { card: "border-blue-900/40 hover:border-blue-700/60",   icon: "bg-blue-950/60 ring-blue-900/60 group-hover:ring-blue-700", text: "text-blue-400",   bar: "bg-blue-500",   badge: "bg-blue-950/40 text-blue-400" },
  emerald: { card: "border-emerald-900/40 hover:border-emerald-700/60", icon: "bg-emerald-950/60 ring-emerald-900/60 group-hover:ring-emerald-700", text: "text-emerald-400", bar: "bg-emerald-500", badge: "bg-emerald-950/40 text-emerald-400" },
  amber:   { card: "border-amber-900/40 hover:border-amber-700/60", icon: "bg-amber-950/60 ring-amber-900/60 group-hover:ring-amber-700", text: "text-amber-400",   bar: "bg-amber-500",   badge: "bg-amber-950/40 text-amber-400" },
} as const;
    ...
    <div className="min-h-full bg-gray-950">
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 space-y-8">
        ...
        <div className="text-center space-y-3">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-teal-950 ring-1 ring-teal-900/60">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="h-7 w-7 text-teal-400">
          ...
          {totalCompleted > 0 && (
            <div className="mx-auto max-w-xs space-y-1.5">
              <div className="flex items-center justify-between text-xs text-gray-500">
                ...
                <span className="font-semibold text-teal-400">{overallPct}%</span>
              </div>
          ...
          {SERIES.map(series => {
            ...
            return (
              <button
                ...
                className={`group relative flex flex-col gap-4 rounded-2xl border bg-gray-900 p-5 text-left transition-all hover:shadow-lg hover:shadow-black/30 ${c.card}`}
              >
                {done && (
