...
const MODES: { href: string; label: string; blurb: string; accent: string; icon: React.ReactNode }[] = [
  { href: "/lobby", label: "Debates", blurb: "Join live rooms", accent: "text-indigo-400",
  ...
  { href: "/compete", label: "Compete", blurb: "1v1, AI judged", accent: "text-violet-400",
  ...
  { href: "/arena", label: "Arena", blurb: "Beat the bots", accent: "text-amber-400",
